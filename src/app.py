...
from data_fetch import fetch_power_data, fetch_smap_soil_moisture, fetch_modis_ndvi
from simulation import simulate_season, CROPS

st.set_page_config(page_title="AgriSense: Smart Farming Simulator", page_icon="🌾")
...
# Fetch climate data for next 3 months
...
if climate_df is not None:
    ...
    st.subheader("🌦️ NASA Climate Forecast (Next 3 Months)")
